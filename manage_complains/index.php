...
<body>
    ...
    <div class="container">
    <h3><a href="../customer" id="customer"><i class="las la-home"></i>User Dashboard</a></h3>
    <a href="../logout.php" id="logout"><i class="las la-power-off"></i>Logout</a>
    <br><br><br>
        ...
        <table>
            ...
            <tbody>
                <?php 
                $sn = 1;
                $sql = "SELECT * FROM complains WHERE email='$user'";
